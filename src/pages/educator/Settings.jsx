    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: "Poppins", sans-serif; }
        ...
        .save-btn { border: none; padding: 11px 18px; border-radius: 8px; background: #6c63ff; color: #fff; cursor: pointer; transition: 0.2s ease; }
        .save-btn:hover { background: #574fd6; transform: translateY(-1px); box-shadow: 0 10px 22px rgba(87, 79, 214, 0.32); }
